...
PROJECT_DIR="/home/ubuntu/custom-site-chat"
...
services:
  ...
  postgres:
    ...
    container_name: postgres-custom-site-chat
    ports:
    ...
    healthcheck:
      test: ["CMD-SHELL", "pg_isready -U sitechat_user -d customsitechat"]
      interval: 10s
      timeout: 5s
      retries: 5
    networks:
  ...
  qdrant:
    ...
    container_name: qdrant-custom-site-chat
    ports:
  ...
  # ==================== Backend ====================
  backend:
    image: esterovrani/custom-site-chat-backend:latest
  ...
  # ==================== Frontend ====================
  frontend:
    image: esterovrani/custom-site-chat-frontend:latest
