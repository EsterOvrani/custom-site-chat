      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
            ...
            <strong style={{ fontSize: '16px' }}>אזהרת אבטחה חשובה!</strong>
          </div>
          <p style={{ margin: '5px 0' }}>
            ❌ <strong>אל תשתמש במפתח הסודי ישירות בקוד JavaScript!</strong>
          </p>
          <p style={{ margin: '5px 0' }}>
            כל מי שצופה בקוד המקור של האתר שלך יוכל לראות את המפתח ולהשתמש בו.
          </p>
          <p style={{ margin: '5px 0' }}>
            ✅ <strong>השתמש בקובץ .env</strong> ובהזרקה מצד השרת (ראה הוראות למטה).
          </p>
        </div>

        <p style={{ color: '#666', marginBottom: '20px', fontSize: '14px' }}>
          הקוד למטה כולל הוראות להטמעה בטוחה. בחר את השיטה המתאימה לטכנולוגיה שלך.
        </p>
